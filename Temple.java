...
public class Temple{
  public Temple(Player x){
    ...
    System.out.println("Write a Profanity -> Press 5");
    
    if(x.dog==0){
      System.out.println("Buy Dog -$30 -> Press 6");
    }
    
    if(x.dog>=1){
      System.out.println("Take care of "+x.dog_name+" -> Press 6");
    }
    
    if(x.dog==1){
      System.out.println("Dress up Dog -$30 -> Press 7");
    }
    ...
    while(true){
      ...
      if (player_choice<=7 && player_choice >0){
        ...
        if (player_choice==1){
          ...
          System.out.println("Profanity "+x.write+"/5");
        
          if(x.write==5){
          System.out.println("Complete. + 20 Zen");
          x.zen=x.zen+20;
          x.write=0;
          }
        }
        ...
        else if (player_choice==7 && x.dog==1){
